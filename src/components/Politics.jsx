...
function Politics() {
  ...
  <div className="container">
    <div className="row">
      <h4 className="text-center">POLITICS STORIES</h4>
      <div className="col-md-8">
        {politics?.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)).map((item, index) => {
          return (
            <div key={item._id} className="row dotted-border-bottom mt-2">
              ...
              <div className="row">
                <div className="col-md-9">
                  <p className="text-paragraph">{item.description.split(' ').slice(0, 20).join(" ")}...<br></br>
